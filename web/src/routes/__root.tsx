...
const DEFAULT_TITLE = "ATM";
const DEFAULT_DESCRIPTION =
  "ATM — the Agent Trajectory Marketplace. Sell the session logs your coding agents leave behind.";
...
function NotFoundComponent() {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-6 bg-atm-ink px-6 text-center text-atm-paper">
      <span className="atm-wordmark text-sm text-atm-teal">404</span>
      <h1 className="atm-headline max-w-md text-3xl sm:text-4xl">
        Page not found.
      </h1>
      <p className="max-w-sm text-sm leading-relaxed text-atm-muted">
        That route doesn't exist. The journey you came for is one link back.
      </p>
      <a href="/" className="atm-btn atm-btn-primary">
        Back to the flight
      </a>
    </main>
  );
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-6 bg-atm-ink px-6 text-center text-atm-paper">
      <h1 className="atm-headline text-3xl sm:text-4xl">This page didn't load.</h1>
      <p className="max-w-sm text-sm leading-relaxed text-atm-muted">
        Something went wrong on our side. Try a refresh, or head home and start over.
      </p>
      <div className="flex flex-wrap items-center justify-center gap-3">
        ...
        <a href="/" className="atm-btn atm-btn-ghost">
          Home
        </a>
      </div>
    </main>
